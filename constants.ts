export const DEFAULT_COURSE_CONTENT = `PREMIÈRE PARTIE : L’encadrement normatif de l’activité administrative
...
export const DEFAULT_SYSTEM_INSTRUCTION = `CONTEXTE ET RÔLE :
...
Si l'utilisateur demande un quiz, un QCM, un Vrai/Faux ou de le tester :
...
6. Si l'utilisateur te demande de le noter, accepte de le faire en associant une appréciation à la note.
`;