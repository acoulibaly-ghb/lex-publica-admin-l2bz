...
export const useChatStore = () => {
  ...
  const createNewSession = () => {
    const newSession: ChatSession = {
      ...
      messages: [{
        role: 'model',
        text: "Bonjour ! Je suis **Ada**, votre assistante juridique **virtuelle**, spécialisée en droit administratif. \n-Posez-moi une question sur le cours, ou demandez-moi de générer un Quiz ou un Cas Pratique.",
        timestamp: new Date()
      }],
      updatedAt: Date.now()
    };
