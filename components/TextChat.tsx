...
import { Send, Bot, User, Loader2, Sparkles, BookOpen, CheckCircle, HelpCircle, Plus, MessageSquare, Trash2, Edit2, X, Check, PanelLeftClose, PanelLeft, Lightbulb, Info, ExternalLink } from 'lucide-react';
